...
def adapt_profile_to_cv(p,text):
    ...
    if "Atendimento" in prof["areas"]:
        queries += ["atendimento ao cliente","customer support","assistente de atendimento",
                    "analista de atendimento júnior","customer service junior"]
...
def fetch_linkedin(p):
    ...
    state_names={"AC":"Acre","AL":"Alagoas","AP":"Amapá","AM":"Amazonas","BA":"Bahia","CE":"Ceará",
                 "DF":"Distrito Federal","ES":"Espírito Santo","GO":"Goiás","MA":"Maranhão","MT":"Mato Grosso",
                 "MS":"Mato Grosso do Sul","MG":"Minas Gerais","PA":"Pará","PB":"Paraíba","PR":"Paraná",
                 "PE":"Pernambuco","PI":"Piauí","RJ":"Rio de Janeiro","RN":"Rio Grande do Norte",
                 "RS":"Rio Grande do Sul","RO":"Rondônia","RR":"Roraima","SC":"Santa Catarina",
                 "SP":"São Paulo","SE":"Sergipe","TO":"Tocantins"}
    state_label=state_names.get(state.upper(),state)
    local_query=", ".join(x for x in [cities[0] if cities else "Brazil",state_label,"Brazil"] if x)
    for q in terms:
...
class App(tk.Tk):
    def __init__(self):
        ...
        if self.cv.strip() and int(self.p.get("perfil_curriculo_versao",0) or 0)<3:
    ...
    def ui(self):
        ...
        for text,value in [("Todas","todas"),("Presencial","presencial"),("Remoto","remoto"),("Estágios","estagio")]:
    ...
    def remove_old_jobs(self):
        ...
        for vid,pub in rows:
            ...
            if age is None:
                ...
                self.conn.execute("UPDATE vagas SET status='Arquivada',selecionada_lote=0 WHERE id=?",(vid,));removed+=1
            else:
                kept+=1
    ...
    def revalidate_modes(self):
        ...
        for r in rows:
            ...
            if ok:
                ...
                self.conn.execute("UPDATE vagas SET status='Ignorada',selecionada_lote=0 WHERE id=?",(vid,));removed+=1
