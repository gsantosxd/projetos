...
ETAPA 3 — MODALIDADE
- Filtro remoto e booleanos legados não são aceitos como prova de Home office.
- Home office exige modalidade confirmada e disponibilidade para Brasil/LATAM/Worldwide/Anywhere.
...
- Os filtros visíveis da lista foram reduzidos a Todas, Home office e Estágio.
...
- Perfil de currículo V2 extrai formações linha a linha, remove período/semestre e rejeita consultas malformadas.
