# Privacidade — Tô no Corre 0.9.1-beta
...
Esses arquivos ficam em `%LOCALAPPDATA%\ToNoCorre\Data` na edição empacotada. A pasta recebe permissões restritas à conta do Windows, ao sistema e aos administradores. Isso não impede acesso por alguém que controle a conta ou seja administrador do computador.
