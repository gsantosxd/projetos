# Privacidade — Tô no Corre 0.9.2-beta-estável
...
Esses arquivos ficam em `%LOCALAPPDATA%\ToNoCorre\BetaEstavel1` na edição empacotada. A pasta recebe permissões restritas à conta do Windows, ao sistema e aos administradores. Isso não impede acesso por alguém que controle a conta ou seja administrador do computador.
